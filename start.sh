...
# 钱包地址
worker_wallet_address=3ucoQSjg6AVpSotpZRCoHV82v6A1hNyMe6kX8Ag36qG9
# 逻辑核心数
...
start_process() {
    ...
    do   
        ...
        local command_base="./ore-mine-pool-linux worker --alias ROGSTRIX --core-range ${core_range} --worker-wallet-address ${worker_wallet_address} >> worker.log 2>&1"
